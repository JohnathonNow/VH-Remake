...
import vhremake.ChooseShips.FileE;
import vhremake.Components.Chassis;
import vhremake.Components.Component;
import vhremake.Components.Gun;
import vhremake.Components.Hull;
import vhremake.Components.RectangularHull;
import vhremake.Components.Saw;
import vhremake.Components.Thruster;
import vhremake.Components.WarpCore;
import vhremake.Entities.Asteroid;
import vhremake.Entities.Bullet;
import vhremake.Entities.Entity;
import vhremake.Entities.Esplosion;
import vhremake.Entities.Nebula;
import vhremake.Entities.Star;
    ...
    public Game() {
        ...
        glcanvas[0].addGLEventListener(new GLEventListener() {
            ...
            public void init(GLAutoDrawable glautodrawable) {
                FPSAnimator animator = new FPSAnimator( glcanvas[0], 60);
                animator.start();
